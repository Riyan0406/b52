...
// dataCard.forEach((isi) =>{
//   testimonialHtml += `
//      <div class="card-testi">
//          <img src="${isi.image}" alt="">
//         <div class="kata-kata">
//             <p class="quots">"${isi.quots}"</p>
//                  <p class="riyan">-"${isi.author}"</p>
//          </div>
//        </div>
//        `
//    })
...
//    document.getElementById("testimoniall").innerHTML= testimonialHtml
...
//   document.getElementById("testimoniall").innerHTML = testimonial;
// }
